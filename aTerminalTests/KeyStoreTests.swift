...
final class KeyStoreTests: XCTestCase {
    ...
    func testGenerateKeyStoresPrivateBytesAndMetadata() throws {
        ...
        XCTAssertTrue(key.publicKeyLine.hasSuffix("aterminal-mac-mini"))
    ...
    func testPublicKeyLineMatchesPrivateKey() throws {
        ...
        let expected = OpenSSHKey.publicKeyLine(privateKey.publicKey, comment: "aterminal-test")
    ...
    func testImportedKeyRoundTripsThroughPEM() throws {
        ...
        let expectedLine = OpenSSHKey.publicKeyLine(original.publicKey, comment: "aterminal-imported")
