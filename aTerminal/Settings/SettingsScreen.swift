...
struct SettingsScreen: View {
    ...
    private let supportURL = URL(string: "https://github.com/AaronCx/a-Terminal/issues")!
    private let privacyPolicyURL = URL(string: "https://aaroncx.github.io/a-Terminal/privacy")!
