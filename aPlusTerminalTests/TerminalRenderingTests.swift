...
final class TerminalRenderingTests: XCTestCase {
    private func makeTerminalView(cols: Int = 40, rows: Int = 10) -> TerminalEmulatorView {
    ...
    private func line(_ view: TerminalEmulatorView, _ index: Int) -> String {
        let terminal = view.getTerminal()
    ...
    func testPlainTextRendersOnFirstLine() {
        ...
        feed(view, "hello aplusterminal")
        XCTAssertEqual(line(view, 0), "hello aplusterminal")
    }
